...
import { Plus, Search, Eye, Edit3, Copy, Trash2, MessageSquareCode } from "lucide-react";
import { mockPromptTemplates } from "@/lib/mock-data";

export default function PromptTemplatesPage() {
  const [search, setSearch] = useState("");
  const filtered = mockPromptTemplates.filter((t) =>
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                <Label>提示词内容</Label>
                <Textarea rows={8} placeholder="输入提示词，使用 {{变量名}} 标记变量..." className="font-mono text-sm" />
              </div>
